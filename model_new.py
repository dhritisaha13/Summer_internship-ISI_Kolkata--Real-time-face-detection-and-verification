...
def yolo_head(feats, anchors, num_classes, input_shape, calc_loss=False):
    ...
    feats = K.reshape(
        feats, [-1, grid_shape[0], grid_shape[1], num_anchors, num_classes + 5])   #(13,13,18) to  (13,13,3,6)
	...
	#alll are of shape #grid shape=(13, 13, 1, 2) (#batch,13,13,3,6) (#batch,13, 13, 1, 2)
...
def yolo_loss(args, anchors, num_classes, ignore_thresh=.5, print_loss=False):
    ...
    '''
    num_layers = len(anchors)//3 # default setting
    yolo_outputs = args[:num_layers]    #list of 3 outputs (13,13,18), (26,26,18) (56,56,18)
